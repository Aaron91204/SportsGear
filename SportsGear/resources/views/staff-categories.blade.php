...
@section('content')
    <div class="container">
       ...
       <div class="jumbotron text-center clearfix">
            <h2>Categories</h2>
            <p>Choose a category to view and edit product details</p>
                    ...
                    <div class="col-md-3">
                        <div class="thumbnail text-center" style="position:relative;">
                            ...
                            <div class="caption " style="position:absolute;top: 45%;left: 0;width: 100%;"">
                                ...
                                <h3><a href="{{ url('staff/updateProducts', [$product->category]) }}" style="color:white;text-shadow: 2px 2px 4px #000000;">{{ $product->category}}</a></h3>
